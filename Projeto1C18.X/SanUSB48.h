...
{ unsigned int k;  
EEADR =REG+0B11110100+tmp;
EEADR =REG+0B11111101;
...
{ unsigned int k; //doze para 48 MHz
...
void escreve_eeprom(char endereco, char dado)   // 8 bits
   {
EECON1bits.EEPGD = 0;
EECON1bits.CFGS = 0;
EECON1bits.WREN = 1;
